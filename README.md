...
- [Prism Scanner](https://github.com/aidongise-cell/prism-scanner) - Security scanner for AI Agent skills, plugins, and MCP servers with 39+ detection rules, AST taint tracking, and A-F grading. `pip install prism-scanner`
