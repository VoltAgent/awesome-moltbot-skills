...
- [skill-taxonomy](https://github.com/SeeleAI/skill-taxonomy) - Structured taxonomy for AI agent skills. Enables discovery, classification, and routing in multi-agent systems.
